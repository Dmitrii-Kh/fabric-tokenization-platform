...
#Install chaincode
#peer chaincode install -n tokenizationcontract -v 1.0 -l node -p /opt/gopath/src/github.com/chaincode
#
##Initiate chaincode
#peer chaincode instantiate -o orderer.example.com:7050 --tls --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem -C $CHANNEL_NAME -n tokenizationcontract -l node -v 1.0 -c '{"Args":[]}'
#
